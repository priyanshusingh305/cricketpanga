      ...
      <div className="container px-4 py-16 md:px-6">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
          <div className="space-y-4 lg:col-span-2">
            ...
            <div className="mt-2 py-2 px-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-lg inline-block">
              <p className="font-bold">Scan Karo, Pay Karo, Join Karo.</p>
            </div>
            ...
            <div className="pt-4 space-y-2">
              <div className="flex items-start gap-2">
                ...
                <span className="text-sm">123 Cricket Street, Mumbai, Maharashtra 400001, India</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">support@cricketpanga.in</span>
              </div>
            </div>
          </div>
