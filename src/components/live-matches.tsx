...
export function LiveMatches() {
  ...
  return (
    <section id="live-matches" className="py-16 bg-white">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-10">
          <div className="space-y-2">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Upcoming & Live Matches</h2>
            ...
            <Card key={match.id} className="overflow-hidden hover:shadow-lg transition-all duration-300 group">
              <CardContent className="p-0">
                <div className="p-4 bg-gradient-to-r from-blue-50 to-blue-100 flex justify-between items-center">
                  ...
                  <div className="text-sm font-medium text-gray-600">Prize Pool: {match.prizePool}</div>
                </div>

                <div className="p-6 flex items-center justify-between">
                  <div className="flex flex-col items-center">
                    <div className="relative h-16 w-16 mb-2 transform group-hover:scale-110 transition-transform">
                      <Image
                    ...
                    <h3 className="text-sm font-semibold">{match.team1}</h3>
                    {match.isLive && <div className="text-xs text-gray-600 mt-1">{match.score1}</div>}
                  </div>

                  <div className="flex flex-col items-center">
                    <div className="text-lg font-bold mb-2">VS</div>
                    {match.isLive && <Badge className="bg-green-600 animate-pulse mb-2">LIVE NOW</Badge>}
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-sm font-semibold">{match.team2}</h3>
                    {match.isLive && <div className="text-xs text-gray-600 mt-1">{match.score2}</div>}
                  </div>
                </div>
                ...
                <div className="p-4 border-t flex justify-between items-center">
                  ...
                  <Button asChild size="sm" className="bg-blue-700 hover:bg-blue-800 group">
